...
import { musicList } from './API/MusicService';
import { listProps } from '../pages/MusicPage';
...
export default function SongPageTabs(tabsList: tabsListProps) {
  const {hitlikeList, latestList} = tabsList
